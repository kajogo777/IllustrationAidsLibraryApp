...
class CheckOutsControllerTest < ActionController::TestCase
  ...
  test "should create check_out" do
    assert_difference('CheckOut.count') do
      post :create, check_out: { check_out_date: @check_out.check_out_date, deadline_date: @check_out.deadline_date, item_id: @check_out.item_id, person_id: @check_out.person_id, released: @check_out.released }
    end
  ...
  test "should update check_out" do
    patch :update, id: @check_out, check_out: { check_out_date: @check_out.check_out_date, deadline_date: @check_out.deadline_date, item_id: @check_out.item_id, person_id: @check_out.person_id, released: @check_out.released }
    assert_redirected_to check_out_path(assigns(:check_out))
  end
