...
class CheckInsControllerTest < ActionController::TestCase
  ...
  test "should create check_in" do
    assert_difference('CheckIn.count') do
      post :create, check_in: { item_id: @check_in.item_id, on_deadline: @check_in.on_deadline, person_id: @check_in.person_id }
    end
  ...
  test "should update check_in" do
    patch :update, id: @check_in, check_in: { item_id: @check_in.item_id, on_deadline: @check_in.on_deadline, person_id: @check_in.person_id }
    assert_redirected_to check_in_path(assigns(:check_in))
  end
